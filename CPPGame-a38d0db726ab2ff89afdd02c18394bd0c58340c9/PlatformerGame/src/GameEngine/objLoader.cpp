...
/*
		stream << "amount of Verts:" << size1 << "\n";
		stream << "amount of UVS:" << size2 << "\n";
		stream << "amount of Normals:" << size3 << "\n";
		stream << "amount of Inds:" << size4 << "\n";*/
		inds = new int[size4];
